                        ...
                        <div className="flex flex-col gap-6 mt-6">
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className={`w-full h-[38px] ${loading ? 'bg-[#7367F0]/70 cursor-not-allowed' : 'bg-[#7367F0]'} text-white text-sm rounded mt-6 flex items-center justify-center font-medium transition-all shadow-sm active:scale-[0.98]`}
                                >
                                    <Loader text="Sending reset link..." loading={loading} title="Send Reset Link" />
                                </button>
                            </form>
